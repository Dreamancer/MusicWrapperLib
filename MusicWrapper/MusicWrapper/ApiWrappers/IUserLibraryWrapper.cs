...
namespace MusicWrapper.ApiWrappers
{
    interface IUserLibraryWrapper
    {
		...
		Task<ApiResponse> GetUserTopAlbums(string user, TopPeriod? period, int? limit, int? page);

		Task<ApiResponse> GetUserTopTracks(string user, TopPeriod? period, int? limit, int? page);
